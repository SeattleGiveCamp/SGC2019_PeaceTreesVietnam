...
export default function Footer() {
  ...
  return (
    <div className={classes.root} style={{position: "relative", top: "80vh"}}>
      <AppBar position="static" color="black" style={{background: "black", paddingTop: "20px"}}>
        <Toolbar>
        ...
        <Toolbar style={{margin: "90px 0 20px 0"}}>
          <Typography className={classes.title} style={{fontSize: "20px"}}>
            ...
            <a href="https://www.instagram.com/peacetreesvietnam/" style={{fontSize: "25px", color: "white", marginRight: "15px"}}
            ><i class="fab fa-instagram"></i></a>
            <a href="https://www.facebook.com/peacetreesvietnam/" style={{fontSize: "25px", color: "white", marginRight: "15px"}}
            ><i class="fab fa-facebook"></i></a>
            <a href="https://twitter.com/peacetreesvn" style={{fontSize: "25px", color: "white", marginRight: "15px"}}
            ><i class="fab fa-twitter"></i></a>
            <a href="https://www.youtube.com/user/peacetreesvietnam" style={{fontSize: "25px", color: "white", marginRight: "15px"}}
